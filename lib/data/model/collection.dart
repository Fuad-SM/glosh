...
CollectionBody collectionBodyFromJson(String str) =>
    CollectionBody.fromJson(json.decode(str));

String collectionBodyToJson(CollectionBody data) => json.encode(data.toJson());
...
class CollectionBody {
  ...
  factory CollectionBody.fromJson(Map<String, dynamic> json) => CollectionBody(
        title: json["title"] == null ? null : json["title"],
        handle: json["handle"] == null ? null : json["handle"],
      );
