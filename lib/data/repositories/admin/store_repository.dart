...
class StoreRepositories {
  static Future<Either<String, Store>> getStore() async {
    ...
    try {
      final response = await _dioHelper.dio().get('/store', options: options);

      Store jsonsData = Store.fromJson(response.data);
